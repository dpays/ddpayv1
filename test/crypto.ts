...
describe('crypto', function() {
    ...
    const testnetPrefix = 'DWB'
    const testnetPair = {
        private: '5JQy7moK9SvNNDxn8rKNfQYFME5VDYC2j9Mv2tb7uXV5jz3fQR8',
        public: 'DWB8FiV6v7yqYWTZz8WuFDckWr62L9X34hCy6koe8vd2cDJHimtgM',
    }
    const mainPair = {
    ...
    it('should conceal private key when inspecting', function() {
        ...
        assert.equal(inspect(key.createPublic(testnetPrefix)), 'PublicKey: DWB8FiV6v7yqYWTZz8WuFDckWr62L9X34hCy6koe8vd2cDJHimtgM')
    })
