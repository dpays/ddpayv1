...
describe('asset', function() {
    ...
    it('should create from string', function() {
        const oneDPay = Asset.fromString('1.000 BEX')
    ...
    it('should parse price', function() {
        const price1 = new Price(Asset.from('1.000 BEX'), Asset.from(1, 'SBD'))
        const price2 = Price.from(price1)
        const price3 = Price.from({base: '1.000 BEX', quote: price1.quote})
        assert.equal(price1.toString(), '1.000 BEX:1.000 SBD')
    ...
    it('should convert price', function() {
        const price1 = new Price(Asset.from('0.500 BEX'), Asset.from('1.000 SBD'))
