...
describe('database api', function() {
    ...
    it('getConfig', async function() {
        ...
        assert.equal(conf['DPAY_CREATE_ACCOUNT_WITH_BEX_MODIFIER'], 30)
    ...
    it('getDiscussions', async function() {
        const r1 = await liveClient.database.getDiscussions('comments', {
            ...
            start_permlink: 're-pal-re-almost-digital-ddpay-a-strongly-typed-dpay-client-library-20170702t131034262z',
            tag: 'almost-digital',
            limit: 1,
        })
